...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    #
    # Why it's wrong:
    # I assumed Pac-Man must have a power pellet and must not touch a ghost.
    # But the question only says Pac-Man must eat all dots and not lose.
    # Losing happens only when touching a ghost without a power pellet.
    # So, touching a ghost with an active power pellet is still a win.