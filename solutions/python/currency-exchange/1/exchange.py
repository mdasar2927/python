...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    commision=(exchange_rate/100)*spread
    exhange_rate_after_commision = exchange_rate + commision
    money_after_exchange = budget/exhange_rate_after_commision
    tot_no_bill = money_after_exchange//denomination
    value_of_tot_bill = tot_no_bill*denomination
    return value_of_tot_bill
